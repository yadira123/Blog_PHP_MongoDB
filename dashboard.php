<?php
    ...
    try {
        ...
        $database = $mongodb->miblog;
        $articleCollection = $database->articles; //$articleCollection = $mongodb->miblog->articles;
    ...
    $totalArticles = count($cursor);//cuenta cuantos valores tiene el array
